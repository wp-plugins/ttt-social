...
class Page_Template_Plugin {
	...
	private function __construct() {
		...
		$this->templates = array(
			...
			'template-twentyten.php' => __( 'Twentyten Template', $this->plugin_slug ),
			'template-twentyeleven.php' => __( 'Twentyeleven Template', $this->plugin_slug ),
			'template-twentytwelve.php' => __( 'Twentytwelve Template', $this->plugin_slug ),
			'template-twentythirteen.php' => __( 'Twentythirteen Template', $this->plugin_slug ),
			'template-twentyfourteen.php' => __( 'Twentyfourteen Template', $this->plugin_slug ),
			'template-twentyfifteen.php' => __( 'Twentyfifteen Template', $this->plugin_slug )
		);
